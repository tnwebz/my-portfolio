...
const Icons = {
  ...
  Git: (
    <svg className="w-7 h-7 sm:w-8 sm:h-8 text-orange-600" viewBox="0 0 24 24" fill="currentColor">
      <path d="M21.6 10.9L13.1 2.4c-.6-.6-1.5-.6-2.1 0L8.6 4.8l2.6 2.6c.4-.2.9-.2 1.3.1.6.6.6 1.6 0 2.2-.4.4-.9.6-1.4.5L8.7 12.6v5c.2.1.4.3.5.5.4.6.3 1.5-.3 2.1-.6.6-1.5.6-2.1 0-.6-.6-.6-1.5 0-2.1.3-.3.8-.5 1.3-.4v-4.9L5.5 10.3c-.6-.6-.6-1.5 0-2.1L8 5.7 2.4 11.3c-.6.6-.6 1.5 0 2.1l8.5 8.5c.6.6 1.5.6 2.1 0l8.6-8.6c.6-.5.6-1.5 0-2.4z"/>
    </svg>
  ),
  GitHub: (
...
const tools: TechItem[] = [
  { name: "Git", glowColor: "rgba(249, 115, 22, 0.22)", iconBg: "from-orange-50/80 to-red-100/40", icon: Icons.Git },
